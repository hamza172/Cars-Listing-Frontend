                        ...
                        <div className="archive-item-cars-single">
                            <div className="row align-items-center p-1">
                                ...
                                {(data.fuelType==="Petrol (Gasoline)"||data.fuelType==="Diesel") && <div className="col-md-8 p-4 single-page-carD">
                                    {(data.brand && data.brand!=="None") && <><span className="blue-text">{translation.Brand[localStorage.getItem("language") || 'Brand']} : </span><span className="grey-text totalcars"><Link className="no-underline" to={'/brands-models/'+data.brand}>{data.brand}</Link></span><br/></>}
                                    {(data.model  && data.model!=="None") && <><span className="blue-text">{translation.Model[localStorage.getItem("language") || 'Model']} : </span><span className="grey-text totalcars"><Link className="no-underline" to={'/brands-models-generation/'+data.brand+'/'+data.model} >{data.model}</Link></span>  <br/></>}
                                    {(data.power  && data.power!=="None") && <><span className="blue-text">{translation.Systempower[localStorage.getItem("language") || 'System Power']} : </span><span className="grey-text totalcars">{data.power}</span>  <br/></>}
                                    {(data.fuelType  && data.fuelType!=="None") && <><span className="blue-text">{translation.FuelType[localStorage.getItem("language") || 'Engine Type']} : </span><span className="grey-text totalcars">{data.fuelType}</span>  <br/></>}
                                    {(data.generation  && data.generation!=="None") && <><span className="blue-text">{translation.Generation[localStorage.getItem("language") || 'Generation']} : </span><span className="grey-text totalcars"><Link to={'/brands-models-generation-cars/'+data.brand+'/'+data.model+'/'+data.generation} className='no-underline'>{data.generation}</Link></span>  <br/></>}
                                    {(data.batterycapacity  && data.batterycapacity!=="None") && <><span className="blue-text">{translation.Batterycapacity[localStorage.getItem("language") || 'Battery Capacity']} : </span><span className="grey-text totalcars">{data.batterycapacity}</span>  <br/></>}
                                    {(data.maximumspeed  && data.maximumspeed!=="None") && <><span className="blue-text">{translation.Maximumspeed[localStorage.getItem("language") || 'Maximum speed']} : </span><span className="grey-text totalcars">{data.maximumspeed}</span>  <br/></>}
                                    {(data.startofproduction && data.startofproduction!=="None")&& <><span className="blue-text">{translation.Startofproduction[localStorage.getItem("language") || 'Production Year']} : </span><span className="grey-text totalcars">{data.startofproduction}</span>  <br/></>}  
                                    {(data.bodytype  && data.bodytype!=="None") && <><span className="blue-text">{translation.Bodytype[localStorage.getItem("language") || 'Body Type']} : </span><span className="grey-text totalcars">{data.bodytype}</span>  <br/></>}  
                                </div>}
                                {(data.fuelType==="petrol / electricity") && <div className="col-md-8 p-4 single-page-carD">
                                    {(data.brand  && data.brand!=="None") && <><span className="blue-text">{translation.Brand[localStorage.getItem("language") || 'Brand']} : </span><span className="grey-text totalcars"><Link to={'/brands-models/'+data.brand}>{data.brand}</Link></span><br/></>}
                                    {(data.model  && data.model!=="None") && <><span className="blue-text">{translation.Model[localStorage.getItem("language") || 'Model']} : </span><span className="grey-text totalcars"><Link className="no-underline" to={'/brands-models-generation/'+data.brand+'/'+data.model} >{data.model}</Link></span>  <br/></>}
                                    {(data.power  && data.power!=="None") && <><span className="blue-text">{translation.Systempower[localStorage.getItem("language") || 'System Power']} : </span><span className="grey-text totalcars">{data.power}</span>  <br/></>}
                                    {(data.fuelType  && data.fuelType!=="None") && <><span className="blue-text">{translation.FuelType[localStorage.getItem("language") || 'Engine Type']} : </span><span className="grey-text totalcars">{data.fuelType}</span>  <br/></>}
                                    {(data.generation  && data.generation!=="None") && <><span className="blue-text">{translation.Generation[localStorage.getItem("language") || 'Generation']} : </span><span className="grey-text totalcars"><Link to={'/brands-models-generation-cars/'+data.brand+'/'+data.model+'/'+data.generation} className='no-underline'>{data.generation}</Link></span>  <br/></>}
                                    ...
                                    {(data.maximumspeed  && data.maximumspeed!=="None") && <><span className="blue-text">{translation.Maximumspeed[localStorage.getItem("language") || 'Maximum speed']} : </span><span className="grey-text totalcars">{data.maximumspeed}</span>  <br/></>}
                                    {(data.startofproduction  && data.startofproduction!=="None") && <><span className="blue-text">{translation.Startofproduction[localStorage.getItem("language") || 'Production Year']} : </span><span className="grey-text totalcars">{data.startofproduction}</span>  <br/></>}  
                                    {(data.modification  && data.modification!=="None") && <><span className="blue-text">{translation.engineType[localStorage.getItem("language") || 'Engine Type']} : </span><span className="grey-text totalcars">{data.modification}</span>  <br/></>}  
                                </div>}
                                {(data.fuelType==="Electricity") && <div className="col-md-8 p-4 single-page-carD">
                                    {(data.brand  && data.brand!=="None") && <><span className="blue-text">{translation.Brand[localStorage.getItem("language") || 'Brand']} : </span><span className="grey-text totalcars"><Link className="no-underline" to={'/brands-models/'+data.brand}>{data.brand}</Link></span><br/></>}
                                    {(data.model  && data.model!=="None") && <><span className="blue-text">{translation.Model[localStorage.getItem("language") || 'Model']} : </span><span className="grey-text totalcars"><Link className="no-underline" to={'/brands-models-generation/'+data.brand+'/'+data.model} >{data.model}</Link></span>  <br/></>}
                                    {(data.fuelType  && data.fuelType!=="None") && <><span className="blue-text">{translation.engineType[localStorage.getItem("language") || 'Engine Type']} : </span><span className="grey-text totalcars">{data.fuelType}</span>  <br/></>}  
                                    {(data.maximumspeed  && data.maximumspeed!=="None") && <><span className="blue-text">{translation.Maximumspeed[localStorage.getItem("language") || 'Maximum speed']} : </span><span className="grey-text totalcars">{data.maximumspeed}</span>  <br/></>}
                                    {(data.generation  && data.generation!=="None") && <><span className="blue-text">{translation.Generation[localStorage.getItem("language") || 'Generation']} : </span><span className="grey-text totalcars"><Link to={'/brands-models-generation-cars/'+data.brand+'/'+data.model+'/'+data.generation} className='no-underline'>{data.generation}</Link></span>  <br/></>}
                                    {(data.batterycapacity  && data.batterycapacity!=="None") && <><span className="blue-text">{translation.Batterycapacity[localStorage.getItem("language") || 'Battery Capacity']} : </span><span className="grey-text totalcars">{data.batterycapacity}</span>  <br/></>}
                                    {(data.startofproduction  && data.startofproduction!=="None") && <><span className="blue-text">{translation.Startofproduction[localStorage.getItem("language") || 'Production Year']} : </span><span className="grey-text totalcars">{data.startofproduction}</span>  <br/></>}  
                                    {(data.electricrange  && data.electricrange!=="None") && <><span className="blue-text">{translation.AllelectricrangeWLTP[localStorage.getItem("language") || 'Engine Range']} : </span><span className="grey-text totalcars">{data.electricrange}</span>  <br/></>}  
                                </div>}
                            </div>
                        </div>
                    </div>
