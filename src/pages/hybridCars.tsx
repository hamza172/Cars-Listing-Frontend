...
import { getAllHybridCars } from "../functions/apiCalls"
import { translation } from "../translation"

export default function AllHybridCars() {
    const [data, setData] =  useState<any[]>([])
    useEffect(()=>{ 
        getAllHybridCars().then((x)=>setData(x))
    },[])

    return (<>
    { data.length>0 ?<div className="container">
        <div className="pageCon">
            <div className="page-title">{translation.topHybridCars[localStorage.getItem("language") || 'Top Hybrid Cars']}</div>
